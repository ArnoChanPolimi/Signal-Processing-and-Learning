...
predictor_idx = [2,13,18,19];  % 预测变量（track 1~19）

% 构建数据集
X_train = click_KPI(:, predictor_idx);  % 预测变量（所有其他 track）
y_train = click_KPI(:, target_idx);  % 目标 track 20
